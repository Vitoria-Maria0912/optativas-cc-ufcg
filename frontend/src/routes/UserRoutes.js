...
export const deleteAllUsersRoute = async () => axios.delete(PROTECTED_API_URL);
...
export const getOneUserByIDRoute = async (id) => axios.get(`${PROTECTED_API_URL}/getByID/${id}`);
...
export const getAllUsersRoute = async () => axios.get(PROTECTED_API_URL);
